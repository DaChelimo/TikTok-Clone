package com.andre_max.tiktokclone.ui.upload.post_video
...
<<<<<<< Updated upstream:app/src/main/java/com/andre_max/tiktokclone/ui/PostVideoFragment.kt
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener
=======
>>>>>>> Stashed changes:app/src/main/java/com/andre_max/tiktokclone/ui/upload/post_video/PostVideoFragment.kt
...
class PostVideoFragment : Fragment() {
    ...
    private fun addVideosToDatabase(videoUrl: String) {
        ...
        val remoteUserVideo = RemoteUserVideo(
            ...
            firestoreId = globalVideosRef.key.toString(),
